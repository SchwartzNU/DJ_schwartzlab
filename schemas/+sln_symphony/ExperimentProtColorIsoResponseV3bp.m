%{
# Block parameters for ColorIsoResponse (3)
...
mean_level                  : float
%}
classdef ExperimentProtColorIsoResponseV3bp < sln_symphony.ExperimentProtocol
    properties
        ...
        dropped_attributes = {'session_id', 'color_combination_mode', 'contrast_range_1', 'contrast_range_2'};
    end
    methods
