%{
#Block parameters for MultiPulse (3) 
...
stim_2_time : float
tail_time : float
log_generator : enum('log', 'cubic')
min_of_log: float
delay_start : smallint unsigned 
%}
classdef ExperimentProtMultiPulseV4bp < sln_symphony.ExperimentProtocol
	properties
		...
		dropped_attributes = {'actual_pre_time'};
	end
	methods
