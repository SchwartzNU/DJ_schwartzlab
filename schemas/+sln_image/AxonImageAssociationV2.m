...
---
%}
classdef AxonImageAssociationV2< dj.Manual
    methods (Static)
        function add_axon_img_asso(axon_arry, img_array, seg_array)
            if (isscalar(axon_arry) && isscalar(img_array) && isscalar(seg_array))
