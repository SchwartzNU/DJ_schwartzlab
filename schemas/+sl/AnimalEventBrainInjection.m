...
classdef AnimalEventBrainInjection < sl.AnimalEvent & dj.Manual
    ...
    properties
        printStr = '%s %s: Animal %d had a brain injection of %s dilluted 1:%d targeting the %s %s. Coordinates (AP,ML,DV,angle): [%0.2f, %0.2f, %0.2f, %0.2f]. Performed by %s. (%s)\n';
        printFields = {'date','time','animal_id','substance_name','dilution','hemisphere','target','coordinates','head_rotation','user_name','notes'};
    end
