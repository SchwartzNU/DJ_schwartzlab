...
door_open_frame = fetch1(sl_behavior.Annotation & ...
    sprintf('event_id=%d',event_id) & ...
...
result_table.Pup_degrees_from_intruder = distance_from_intruder;
result_table.Smell_present = repmat(smell_condition, n_retrievals, 1);
result_table.Intruder_type = repmat(intruder_type, n_retrievals, 1);
