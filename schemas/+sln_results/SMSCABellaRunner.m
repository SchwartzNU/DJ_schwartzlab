...
%}
classdef SMSCABellaRunner < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            key.analysis_name = 'SMS_CA_Bella';
            q = sln_results.DatasetSMSCABella & key & 'LIMIT 1 PER source_id ORDER BY entry_time DESC';
            if q.exists
    ...
    methods 
        function err = errors(self)
            err = self.keySource - sln_results.SMSCABellaRunner;
        end
    end
end