...
example_segment=NULL : longblob # Vector with the voltage of the post stimulation segment
example_sp=NULL : longblob # Idk. Was drunk when I coded this
example_spike_count=NULL : longblob # Vector of spike counts for the example traces
