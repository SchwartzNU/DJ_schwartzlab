...
example_ahp=NULL : float # ahp area for the example traces
example_diff=NULL : float # Vector with differences of AHP voltage and vrest.
...
example_traces=NULL : float # waveforms of example traces (mV). Usually the first epoch.
