...
n_epochs_per_contrast=NULL : longblob # vector with how many trials for each contrast
pre_time_ms=NULL : float # time before stimulus onset (ms)
psth_by_contrast=NULL : longblob # full  psth by contrast image with 10 ms bins or other binning if specified in params
...
%}
classdef DatasetContrastResponseCA < dj.Manual
end
