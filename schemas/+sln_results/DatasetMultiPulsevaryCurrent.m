...
vmax : longblob # maximum positive deflection above steady state during current (mV)
vmax_norm : longblob # maximum positive deflection above steady state during current (normalized to max)
