%{
# MultiPulse Spike Waveform Runner
...
%}
classdef MultiPulseSpikeWaveformRunner < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            key.analysis_name = 'MultiPulse_spike_waveform';
    ...
    methods 
        function err = errors(self)
            err = self.keySource - sln_results.MultiPulseSpikeWaveformRunner;
        end
    end
end