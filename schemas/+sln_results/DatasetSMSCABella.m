...
spikes_pre_var=NULL : longblob # spike count in pre time, variance 
spikes_stim_var=NULL : longblob # spike count in stim time, variance
...
spikes_tail_var=NULL : longblob # spike count in tail time, variance
...
%}
classdef DatasetSMSCABella < dj.Manual
end
