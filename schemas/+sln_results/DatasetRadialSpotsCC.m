...
peak_matrix_mean=NULL : longblob # peak depolarization (mV) of median filtered traces in the same matrix format as trace_matrix_mean
...
%}
classdef DatasetRadialSpotsCC < dj.Manual
end
