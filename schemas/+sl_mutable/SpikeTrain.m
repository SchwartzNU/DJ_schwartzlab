...
classdef SpikeTrain < dj.Imported
    properties (Constant)
        ...
        keySource = proj(...
             (sl.Epoch & "recording_mode='Cell attached' OR recording2_mode='Cell attached' OR (recording_mode='Whole cell' AND cell_id LIKE '040221Ac%')")... #796 whole cell epochs, for testing
             * sl_mutable.RecordingChannels...
          ) - sl_mutable.SpikeTrainMissing...
          & "(recording_mode='Cell attached' AND channel=1) OR (recording2_mode='Cell attached' AND channel=2) OR (recording_mode='Whole cell' AND channel=1)";
    end
