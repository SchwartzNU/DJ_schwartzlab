%NOTICE THIS IS A MODIFIED VERSION OF ORIGINAL ALGORITHM BY XIN
%I disabled the part where the script GUESS if the data is current or voltage clamp
%and set the analysis to be voltage clamp only
...
%XIN's HACKING HERE
%since I will only use voltage clamp data with this script, I disabled the guessing part where it could judge the data
%to be current clmap. And leave the setting set for voltage clamp
%if your data is current clmap and need this script, do the reversal
