classdef BlockParams < dj.internal.GeneralRelvar
    ...
    methods
        function self = BlockParams(protocolBaseName)    
            
            %% get the protocol function handles
            cx = sln_symphony.getSchema().classNames;
            bre = sprintf('sln_symphony.ExperimentProt%sV\\d+bp',protocolBaseName);
