function R = PairedSpots_CC(data_group, params)
datasets = aka.Dataset & data_group;
datasets_struct = fetch(datasets);
N_datasets = datasets.count;

R = sln_results.table_definition_from_template('PairedSpots_CC',N_datasets);
for d=1:N_datasets
    tic;
    ...
    for i=1:N_epochs
        ...
        for s=1:Nspots
            ...
            [sp_count, sp_times] = response_for_spot(sp, ...
                sample_rate, ...
                frame_rate, ...
                pre_ms, ...
                spot_pre_frames, ...
    ...
    function [val, sp_times] = response_for_spot(sp, ...
            sample_rate, ...
            frame_rate, ...
            pre_ms, ...
            spot_pre_frames, ...
