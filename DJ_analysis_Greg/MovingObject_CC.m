function R = MovingObject_CC(data_group, params)
...
R.Properties.UserData = 'MovingObject_CC';
...
for d=1:N_datasets
    ...
    for s=1:N_speeds
        for dir = 1:N_directions
            ...
            mean_trace_baseline_subtracted = mean_trace - resting(c);
            [peak_val, ind] = max(mean_trace_baseline_subtracted);
