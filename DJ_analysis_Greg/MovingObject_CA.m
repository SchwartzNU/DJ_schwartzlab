...
R.Properties.VariableDescriptions = ...
    ...
    'peak firing rate (Hz)', ...
    'peak_firing_time from start of epoch (s)', ...
    'peak firing time relative to time object is in screen center (s)', ...
...
for d=1:N_datasets
    ...
    epochs_in_dataset = sln_symphony.DatasetEpoch * ...
        ...
        aka.BlockParams('MovingObject') * ...
        aka.EpochParams('MovingObject')  & ...
        datasets_struct(d);
