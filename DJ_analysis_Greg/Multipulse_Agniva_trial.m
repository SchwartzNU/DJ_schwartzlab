function R = Multipulse_Agniva_trial(data_group, params)
datasets = aka.Dataset & data_group;
datasets_struct = fetch(datasets);
N_datasets = datasets.count;
R = sln_results.table_definition_from_template('MultiPulse_Agniva_trial',N_datasets);
for d=1:N_datasets
    tic;
    ...
    sag_amplitude_array = nan(number_of_trials,1);
    ...
    for trial = 1:number_of_trials
        ...
        sag_amplitude_array = min_Vm - stable_Vm;
    ...
    R.sag{d} =sag_array ;
    R.sag_amplitude{d} =sag_amplitude_array;
