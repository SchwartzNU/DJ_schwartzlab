...
for d=1:N_datasets
    ...
    for trial = 1:number_of_trials
        ...
        %resistance fit
        stable_Vm = mean(hyper_Vm(floor(mean([start_time,end_time])):end_time,hyper_epoch_less_than_minus50));
        R_linear = fitlm(hyper_current_level_pA(hyper_epoch_less_than_minus50), stable_Vm');
