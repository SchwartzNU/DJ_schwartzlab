function required_fields = plot_RadialSpots_VC_peak(R,ax)
if nargin < 1
...
ylabel(ax, 'y (µm)');
c = colorbar(ax);
c.Label.String = 'Peak response (pA)';

% a2 = nexttile;
% errorbar(a2, R.spot_dist, nanmean(R.peak_matrix_mean,1), nanmean(R.peak_matrix_sem,1));
