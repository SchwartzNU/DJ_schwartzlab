function required_fields = plot_SMS_VC_zeroed_traces(R,ax)
if nargin < 1
    required_fields = {'mean_zeroed_traces', 'spot_sizes', 'sample_rate', 'pre_time_ms'};
    return;
end

set(ax, 'XLim',[-inf inf]);
traces = R.mean_zeroed_traces;
