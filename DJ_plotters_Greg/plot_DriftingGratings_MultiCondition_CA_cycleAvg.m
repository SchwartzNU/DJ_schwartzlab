function required_fields = plot_DriftingGratings_MultiCondition_CA_cycleAvg(R,condition_struct,ax)
if nargin < 1
    required_fields = {'cycle_avg_psth_by_condition', ...
        'speeds', 'directions', 'halfwidths', 'contrasts'};
    return;
end

binSize = 10; %ms
trace_set = R.cycle_avg_psth_by_condition;
...
if N_traces==1
    ...
    time_axis = (0:Nsamples-1) / binSize * 1E-3;
